            ...
            <div class="row">
                ...
                <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar vh-100">
                    <div class="sidebar-brand d-flex align-items-center">
                        <a href="#" class="text-decoration-none text-white px-3 py-2 w-100">NetServa HCP</a>
                    </div>
                ...
                <!-- Main content -->
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-3 bg-dark">
                    <nav class="navbar navbar-expand-md d-md-none mb-3">
...
HTML;
    ...
    private function generateNavDropdown(array $n, string $o, string $t) : string
    {
        ...
        <li class="nav-item">
            ...
            <div class="collapse bg-dark bg-opacity-75 rounded-1 mx-2 mt-1" id="{$id}Submenu">
